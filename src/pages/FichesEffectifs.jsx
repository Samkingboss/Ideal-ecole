...
export default function FichesEffectifs({ eleves = [], classes = [], onCertificat, onCarte, apercuImpression = false }) {
  ...
  return <section className={`effectifs-module ${apercuImpression ? 'print-preview' : ''}`}>
    <style>{`
      ...
      @media(max-width:760px){.effectifs-topline{align-items:flex-start;flex-direction:column}.effectifs-stats{width:100%;min-width:0}.effectifs-description{white-space:normal}.effectifs-tools{grid-template-columns:1fr}.effectifs-print{min-height:42px}}@media print{body *{visibility:hidden!important}.effectifs-module,.effectifs-module *{visibility:visible!important}.effectifs-module{position:absolute;inset:0;width:100%;padding:12mm;box-sizing:border-box}.effectifs-hero{box-shadow:none;border-radius:0;padding:11px 16px}.effectifs-topline{gap:14px}.effectifs-brand{gap:10px}.effectifs-logo{width:50px;height:44px}.effectifs-school{font-size:16px}.effectifs-heading{margin-top:7px}.effectifs-description{white-space:nowrap;line-height:1.3}.effectifs-stats{min-width:350px}.effectifs-stat{padding:6px 9px}.effectifs-stat strong{font-size:18px}.effectifs-tools,.effectifs-classes,.effectifs-actions{display:none!important}.effectifs-table-wrap{border:0;border-radius:0}.effectifs-table{min-width:0;font-size:11px}.effectifs-table th,.effectifs-table td{padding:7px 8px}@page{size:A4 portrait;margin:0}}
    `}</style>
