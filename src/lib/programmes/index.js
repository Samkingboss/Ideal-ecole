...
import mathematicsCE1 from './mathematics-ce1'
import francaisCE2 from './flamboyant-ce2'
import mathematicsCM from './mathematics-cm'
import englishCM from './english-cm'
import spellingCM from './spelling-cm'
import grammarCM from './grammar-cm'
import grammarCP1 from './grammar-cp1'
import { phonicsCP1, phonicsCP2 } from './phonics-pathways'

export const MANUELS = [mathsCP1, mathsCP2, lectureCP1, lectureCP2, francaisCP2, englishCP1, mathematicsCP1, englishCP2, scienceCP2, scienceCP1, phonicsCP1, phonicsCP2, mathsCE1, englishCE1, scienceCE1, mathematicsCE1, francaisCE2, mathematicsCM, englishCM, spellingCM, grammarCM, grammarCP1]
