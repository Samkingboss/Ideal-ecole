...
case "${1:-}" in
  --statique) lance statiques.sh; lance ecrans.sh; lance cliquets.sh
              ...
              lanceJS test-confidentialite.mjs; lanceJS test-remarques.mjs; lanceJS test-devoirs.mjs; lanceJS test-devoirs-selection.mjs; lanceJS test-periode-scolaire.mjs; lanceJS test-message-parent.mjs; lanceJS test-devoirs-fichiers.mjs; lanceJS test-pdf-multipage.mjs; lanceJS test-impression-documents.mjs; lanceJS test-depot-ra.mjs
  ...
  *)          lance statiques.sh; lance ecrans.sh; lance cliquets.sh
              ...
              lanceJS test-devoirs.mjs; lanceJS test-devoirs-selection.mjs; lanceJS test-periode-scolaire.mjs; lanceJS test-message-parent.mjs; lanceJS test-devoirs-fichiers.mjs; lanceJS test-pdf-multipage.mjs; lanceJS test-impression-documents.mjs; lanceJS test-depot-ra.mjs; lanceJS test-notification-preparation.mjs
